...
//modified for SQL Lab
        ...
        /////////////////////////////
        // DEBUG Code for SQL Lab
        $myFile = "/var/www/html/debug.txt";
        $fh = fopen($myFile, 'w') or die("can't open file");
        $Data = "UPDATE user SET name='$name',email='$email', tel1='$tel1', tel2='$tel2', company='$company',zip='$zip',gender='$gender',url='$url',adress='$address1',adress2='$address2',state='$state',country='$country',tags='$tags',locale='$locale',rate='$rate' WHERE ID = $id";
        fwrite($fh, $Data . "\n");
        fclose($fh);
        /////////////////////////////
...
//modified for SQL Lab
        ...
        $myFile = "/var/www/html/debug.txt";
        $fh = fopen($myFile, 'w') or die("can't open file");
        $Data = "SELECT ID, name, locale, lastlogin, gender FROM user WHERE (name = '$user' OR email = '$user') AND pass = '$pass'";
        fwrite($fh, $Data . "\n");
        fclose($fh);
        /////////////////////////////
